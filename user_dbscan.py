...
X = sp.load_npz('/root/workspace/GraphCluster/user_feature/user_dis.npz')
...
def make_dbscan(num):
    ...
    print('eps,\tmin_samples,\tCluter num,\tNoise num,\t,core num,\tcost time')
    print('{},\t{},\t{},\t{},\t{},\t{}'.format(eps, min_samples, n_clusters_, n_noise_, n_core_, time.time()-start))
